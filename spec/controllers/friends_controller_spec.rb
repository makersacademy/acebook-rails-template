...
RSpec.describe FriendsController, type: :controller do
  ...
  describe 'GET #edit' do
    it 'returns a success response' do
      ...
      get :edit, params: { id: friend.to_param }, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Friend' do
        expect do
          post :create, params: { friend: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { friend: invalid_attributes }, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested friend' do
        friend = Friend.create! valid_attributes
        put :update, params: { id: friend.to_param, friend: new_attributes }, session: valid_session
        friend.reload
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested friend' do
      friend = Friend.create! valid_attributes
      expect do
        delete :destroy, params: { id: friend.to_param }, session: valid_session
      end.to change(Friend, :count).by(-1)
    end
