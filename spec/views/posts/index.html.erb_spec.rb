...
RSpec.describe "posts/index.html.erb", type: :view do
  ...
  let(:post1) { double(:post,id: 1, message: "1st post", created_at: DateTime.now, updated_at: DateTime.now, user_id: 1) }
  let(:post2) { double(:post,id: 2, message: "2nd post", created_at: DateTime.now, updated_at: DateTime.now, user_id: 1) }
