...
class Friendship < ApplicationRecord
  ...
  def self.create_reciprocal_for_ids(user_id, friend_id)
    user_friendship = Friendship.create(user_id: user_id, friend_id: friend_id, requester: user_id)
    friend_friendship = Friendship.create(user_id: friend_id, friend_id: user_id, requester: user_id)
