...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase".freeze, "Hiro Asari".freeze, "Sarah Hodne".freeze, "joshua-anderson".freeze, "Aaron Hill".freeze, "Buck Doyle".freeze, "Peter Souter".freeze, "Christopher Grim".freeze, "Joe Corcoran".freeze, "Peter van Dijk".freeze, "Aakriti Gupta".freeze, "Max Barnash".freeze, "Ren\u{e9}e Hendricksen".freeze, "carlad".freeze, "Ke Zhu".freeze, "Carlos Palhares".freeze, "Dan Buch".freeze, "Mar\u{ed}a de Ant\u{f3}n".freeze, "Mathias Meyer".freeze, "mariadeanton".freeze, "Tobias Bieniek".freeze, "Andreas Tiefenthaler".freeze, "Corinna Wiesner".freeze, "David Rodr\u{ed}guez".freeze, "Stefan Nordhausen".freeze, "Igor Wiedler".freeze, "Thais Camilo and Konstantin Haase".freeze, "Joep van Delft".freeze, "Jonne Ha\u{df}".freeze, "Josh Kalderimis".freeze, "Julia S.Simon".freeze, "Justin Lambert".freeze, "Daniel Chatfield".freeze, "Laurent Petit".freeze, "Maarten van Vliet".freeze, "Mario Visic".freeze, "john muhl".freeze, "Adam Lavin".freeze, "Matteo Sumberaz".freeze, "Matthias Bussonnier".freeze, "Michael Mior".freeze, "Michael S. Fischer".freeze, "Miro Hron\u{10d}ok".freeze, "Neamar".freeze, "Nero Leung".freeze, "Nicolas Bessi (nbessi)".freeze, "Peter Bengtsson".freeze, "Benjamin Manns".freeze, "Basarat Ali Syed".freeze, "Piotr Sarnacki".freeze, "Rapha\u{eb}l Pinson".freeze, "Rob Hoelz".freeze, "Robert Van Voorhees".freeze, "Sven Fuchs".freeze, "Tobias Wilken".freeze, "Zachary Gershman".freeze, "Zachary Scott".freeze, "Adrien Brault".freeze, "jeffdh".freeze, "Harald Nordgren".freeze, "HaraldNordgren".freeze, "Eric Herot".freeze, "George Millo".freeze, "Igor".freeze, "Jacob Atzen".freeze, "Jacob Burkhart".freeze, "Dominic Jodoin".freeze, "Joe Rafaniello".freeze, "Jon-Erik Schneiderhan".freeze, "Jonas Chromik".freeze]
  s.date = "2019-05-08"
