...
Devise.setup do |config|
  ...
  # config.secret_key = 'd9044b7285448cc85b89e9cf2792d63d9acb85e61e16d80d31e4e6438ab305b9efd54bdb2b1bb905faa4086af23d5b45f10120355ecfca1e43bba6bd2b8af2d4'
  ...
  # It can be set to an array that will enable
  # params authentication only for the
  ...
  # algorithm), the cost increases exponentially with the
  # number of stretches (e.g.
  # a value of 20 is already extremely slow: approx.
  # 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = 'b57eec0f557f9cf3f76a823d0ccd85021e6c74f9b06bbe99c66dc273125dde0cd9a03bba1af67ca5a3c31751bc248f08c9352c67a339a8c1822169388c843789'
