...
Rails.application.configure do
  ...
  # test suite. You never need to work
  # with it otherwise. Remember that
  # your test database is "scratch space"
  # for the test suite and is wiped
  # and recreated between test runs.
  # Don't rely on the data there!
  config.cache_classes = true

  # Do not eager load code on boot.
  # This avoids loading your whole application
  # just for the purpose of running a single test.
  # If you are using a tool that
  # preloads Rails for running tests,
