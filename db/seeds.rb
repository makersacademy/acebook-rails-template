...
many_post = User.create(email: "George.Manyposts@gmail.com", first_name: "George", last_name: "Manyposts", password: "gm1234")
one_post = User.create(email: "Percy.Onepost@gmail.com", first_name: "Percy", last_name: "Onepost", password: "po1234")
few_post = User.create(email: "Sarah.Fewposts@gmail.com", first_name: "Sarah", last_name: "Fewposts", password: "sf1234")
no_post = User.create(email: "Clare.Noposts@gmail.com", first_name: "Clare", last_name: "Noposts", password: "cn1234")
...
Post.create(message: "A post with a single /n newline to split the text box", user_id: many_post.id)
Post.create(message: "A post /n with /n a few /n newlines", user_id: few_post.id)
