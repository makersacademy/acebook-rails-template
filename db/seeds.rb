...
user2 = User.create!({username: "aosidj", firstname: "Joanne", lastname: "A", email: "hellox@test.com", password: "hello2", birthday: '01/02/1998', bio:  "Praesent consequat, mauris ac volutpat feugiat quis nibh molestie, eleifend aliquet tortor." })
...
Comment.create(user_id: user1.id, post_id: post1.id, content: "Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et ")
Comment.create(user_id: user2.id, post_id: post2.id, content: "Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et ")
Comment.create(user_id: user3.id, post_id: post1.id, content: "Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et ")
Comment.create(user_id: user2.id, post_id: post3.id, content: "Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et ")
